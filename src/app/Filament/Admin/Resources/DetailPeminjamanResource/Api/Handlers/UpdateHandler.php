...
use App\Filament\Admin\Resources\DetailPeminjamanResource\Api\Requests\UpdateDetailPeminjamanRequest;
...
class UpdateHandler extends Handlers {
     ...
     *
     * @param UpdateDetailPeminjamanRequest $request
     * @return \Illuminate\Http\JsonResponse
     */
    public function handler(UpdateDetailPeminjamanRequest $request)
    {
        $id = $request->route('id');
